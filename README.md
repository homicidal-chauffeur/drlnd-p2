...
The project uses the [Reacher](https://github.com/Unity-Technologies/ml-agents/blob/master/docs/Learning-Environment-Examples.md#reacher) environment.
...
2. Create the conda environment. The Unity environment is tagged to a pretty old
`unityagents` library, which in turn limits the GRPC version and that limits the tensorboardX
version.
